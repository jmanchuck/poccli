...
func (mdb *MassDBV1) Plot() chan error {
	...
	mdb.wg.Add(1)
	go mdb.executePlot(result) // goroutine
...
func (mdb *MassDBV1) GetFilePathA() string {
	return mdb.filePathA
}

func (mdb *MassDBV1) GetFilePathB() string {
	return mdb.filePathB
}
...
func (mdb *MassDBV1) GetProof(challenge pocutil.Hash) (*poc.Proof, error) {
	...
	logging.CPrint(logging.INFO, "MassDBV1 GetProof")
	proof := &poc.Proof{
		X:         x,
		XPrime:    xp,
		BitLength: bl,
